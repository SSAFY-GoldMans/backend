...
import static com.goldmen.common.utils.ConvertPrice.priceToStr;

public class Mapper {
    private Mapper() {
    }

    public static NearMetroResponse stationToNearMetroResponse(Station station, int price, int time, int count, List<Integer> lines) {
